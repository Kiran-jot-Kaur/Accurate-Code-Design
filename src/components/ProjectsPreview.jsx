      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mt-4 text-gray-600">
            Students don’t work on random websites. Each project is
            designed to match real industry use cases.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="rounded-lg border p-8 hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              A complete admin panel with authentication, user roles,
              analytics charts, and responsive UI built using React and
              backend APIs.
            </p>
          </div>
          ...
          <div className="rounded-lg border p-8 hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              ...
              real-time conversations, message handling, and smart
              responses.
            </p>
          </div>
