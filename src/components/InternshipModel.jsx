    ...
    <section className="py-16">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="rounded-lg bg-gray-500 p-6 shadow-sm">
            <span className="text-sm font-semibold text-gray-800">Step 01</span>
            <h3 className="mt-3 mb-2 text-lg font-semibold text-white">Skill Training</h3>
          ...
          <div className="rounded-lg bg-gray-500 p-6 shadow-sm">
            <span className="text-sm font-semibold text-gray-800">Step 02</span>
            <h3 className="mt-3 mb-2 text-lg font-semibold text-white">Product Work</h3>
            <p className="text-gray-900">
          ...
          <div className="rounded-lg bg-gray-500 p-6 shadow-sm">
            <span className="text-sm font-semibold text-gray-800">Step 03</span>
          ...
          <div className="rounded-lg bg-gray-500 p-6 shadow-sm">
            <span className="text-sm font-semibold text-gray-800">Step 04</span>
            <h3 className="mt-3 mb-2 text-lg font-semibold text-white">
