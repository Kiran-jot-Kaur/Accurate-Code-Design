    ...
    <header className="fixed top-0 left-0 z-50 w-full border-b bg-transparent backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="text-xl font-bold flex items-center">
          <img src={Logo} alt="Accurate Code Design Logo" className="h-12 max-w-full object-contain border-2 border-white rounded-full" />
      ...
      {isOpen && (
        <div className="md:hidden border-t bg-slate-300">
          <nav className="flex flex-col px-6 py-4 gap-4">
            ...
            <NavLink to="/internship" className="nav-link" onClick={() => setIsOpen(false)}>Internship</NavLink>
